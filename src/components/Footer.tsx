...
const footerLinks = {
  ...
  learn: [
    ...
    { name: "Code Examples", href: "/learn/code" },
    { name: "Projects", href: "/learn/projects" },
  ],
  company: [
...
const socialLinks = [
  ...
  { icon: Mail, href: "mailto:hello@sensoriot.com", label: "Email" },
];
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-sm text-muted-foreground mb-6 max-w-xs">
              ...
              Discover, simulate, and innovate.
            </p>
            {/* Social Links */}
          ...
          <div>
            <h4 className="font-display font-semibold text-sm mb-4 text-foreground">Learn</h4>
            <ul className="space-y-3">
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Sensor & IoT Explorer. All rights reserved.
          </p>
          <p className="text-sm text-muted-foreground">
            Built with <span className="text-primary">♥</span> for makers everywhere
          </p>
        </div>
      </div>
    </footer>
